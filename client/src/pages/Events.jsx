        ...
        <div className="min-h-screen bg-[#fcfaff] pt-32 pb-32 px-6">
            ...
            <div className="container mx-auto max-w-7xl">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8 px-4">
                    ...
                    >
                        <h1 className="text-5xl font-black text-[#1e1b4b] mb-4 tracking-tighter uppercase italic">
                            DISCOVER
                        </h1>
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-40 gap-6">
                        ...
                        <p className="text-indigo-400 font-black text-xs tracking-widest uppercase animate-pulse">
                    ...
                    <div className="text-center py-40 bg-white/50 backdrop-blur-3xl rounded-[4rem] border border-white/40 shadow-2xl shadow-indigo-100/10">
                        ...
                        <h3 className="text-3xl font-black text-[#1e1b4b] mb-4 uppercase italic">
                            Event Not Found!
                        </h3>

                        <p className="text-gray-400 font-medium mb-12 text-lg">
                            No active events found for this sector.
                        </p>

                        <button
                            onClick={() => setSearch('')}
                            className="bg-indigo-600 text-white px-10 py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl hover:bg-[#1e1b4b] transition-all flex items-center gap-3 mx-auto"
                        >
                            Reset Search
                            <FaSearch />
                        </button>
                            ...
                            >
                                ...
                                <div className="bg-white rounded-[2.5rem] overflow-hidden shadow-2xl shadow-indigo-100/50 border border-indigo-50 flex flex-col h-full transition-transform duration-500 hover:-translate-y-4">
                                    ...
                                    <div className="p-10 flex-grow flex flex-col">
                                        ...
                                        {/* Title */}
                                        <h3 className="text-2xl font-black text-[#1e1b4b] mb-8 leading-tight group-hover:text-indigo-600 transition-colors">
