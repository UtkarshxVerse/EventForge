...
const users = [
    { name: 'Admin User', email: 'admin@eventforge.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@eventforge.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@eventforge.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@eventforge.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@eventforge.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@eventforge.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@eventforge.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@eventforge.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@eventforge.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@eventforge.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@eventforge.com');
        console.log('User Email:  user@eventforge.com');
